...
| P1 | `docs-media` | 56.90 | 11 | 9 | 2 | 9 route authorities; 3 suspected overlap pairs; 5 shared broad keywords; 5 tool-like primary candidates; 7 candidates with scripts/references/assets |
